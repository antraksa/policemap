...
Date.prototype.fineFormat = function() {
    ...
    var res = day_diff == 0 && (diff < 60 && "только что" || diff < 120 && "минуту назад" || diff < 3600 && Math.floor(diff / 60) + " минут назад" || diff < 7200 && "час назад" || diff < 86400 && Math.floor(diff / 3600) + " часов назад") || day_diff == 1 && "вчера" || day_diff < 7 && day_diff + " дней назад" || day_diff < 31 && Math.ceil(day_diff / 7) + " weeks ago";
    return res;
